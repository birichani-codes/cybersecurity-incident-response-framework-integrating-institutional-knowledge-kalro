...
write('server/store.js', `const fs = require('fs');
const path = require('path');
...
write('server/middleware/rbac.js', `const ROLE_HIERARCHY = { super_admin: 4, analyst: 3, viewer: 2, system: 1 };
...
write('server/data/incidents.json', JSON.stringify([
  ...
  {"id":"inc2","title":"Ransomware Detected on Research Workstation","type":"ransomware","severity":"critical","status":"resolved","description":"A ransomware variant (LockBit 3.0) was detected on a research workstation in the Crop Sciences lab. Files in the shared drive were partially encrypted before isolation.","entities":{"ips":["10.0.2.45"],"file_hashes":["d41d8cd98f00b204e9800998ecf8427e"],"hostnames":["ws-cropscience-04"]},"reported_by":"u4","assigned_to":"u2","created_at":"2024-04-12T14:22:00Z","updated_at":"2024-04-13T10:00:00Z"},
...
write('server/data/annotations.json', JSON.stringify([
  {"id":"a1","knowledge_id":"k1","user_id":"u4","note":"Used this during the August PowerShell incident — checking auth logs within 30 min of click events was particularly useful.","created_at":"2024-08-15T10:30:00Z"},
  {"id":"a2","knowledge_id":"k2","user_id":"u2","note":"Confirmed: NoMoreRansom had no decryptor for LockBit 3.0 as of April 2024. Restored from backup successfully.","created_at":"2024-04-13T11:00:00Z"},
  {"id":"a3","knowledge_id":"k4","user_id":"u4","note":"HR escalation was sensitive — legal needed to be looped in before any action. Do not skip this step.","created_at":"2024-06-19T14:00:00Z"}
], null, 2));
...
console.log('\n✅ All files written. Now copy the page/component files from Claude.');
